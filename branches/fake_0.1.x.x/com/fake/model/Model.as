/* SVN FILE: $Id: Model.as 149 2008-08-27 21:08:14Z gwoo.cakephp $ */
/**
 * Description
 *
 * Fake
...
package com.fake.model
{
	...
	public dynamic class Model extends FakeObject
	{
		...
		*/
		...
		{
			try {
				var ClassRef:Class = DescribeUtil.instance.definition("com." + ConfigManager.instance.app + ".model." + name);
				var model:Model = new ClassRef();
