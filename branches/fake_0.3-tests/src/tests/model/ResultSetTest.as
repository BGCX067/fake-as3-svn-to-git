/* SVN FILE: $Id: ResultSetTest.as 191 2008-09-16 15:09:38Z gwoo.cakephp $ */
/**
 * Description
 *
 * Fake Tests
	...
	public class ResultSetTest extends FakeTestCase
	{
		...
		public static function suite():TestSuite {
   		...
   		public function testStandardView():void
   		{
			...
			assertEquals("value of field 1", resultSet.dataSet.Detail.field1);
			assertEquals("joe",  resultSet.dataSet.User.username);

			assertEquals(1, resultSet.dataSet.current.Comment.id);
   		}
