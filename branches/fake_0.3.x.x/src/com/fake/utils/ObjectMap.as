/* SVN FILE: $Id: ObjectMap.as 244 2009-03-19 01:23:43Z gwoo.cakephp $ */
/**
 * Description
 *
 * Fake
 ...
 * @lastmodified	$Date: 2009-03-19 07:23:43 +0600 (Thu, 19 Mar 2009) $
...
package com.fake.utils
{
	...
	public dynamic class ObjectMap extends ObjectProxy
	{
		...
		public function queryMatchValue(key:String, value:Object, prop:String = "*"):Array
		{
			var foundObjects:Array = find(key);
			...
			for each(var foundObject:Object in foundObjects)
			{
				...
				{
					if(String(String(foundObject[searchProp]).toLowerCase()).indexOf(String(value).toLowerCase()) != -1 && results.indexOf(foundObject) == -1)
		...
		public function queryPropertyList(key:String, prop:String):Array
		{
			var results:Array = [];
			
			for each(var obj:Object in find(key))
			{
				if(results.indexOf(obj[prop]) == -1)
