<?php
/* SVN FILE: $Id: amf_dispatcher.php 19 2008-03-11 17:03:47Z gwoo.cakephp $ */
/**
 ...
 * @lastmodified	$Date: 2008-03-11 23:03:47 +0600 (Tue, 11 Mar 2008) $
 ...
 * @var array
 */
	var $types = array(array('float' => 0x00, 'byte' => 0x01, 'str' => 0x02, 'object' => 0x03, 'movie_clip' => 0x04, 'null' => 0x05,
	...
	function __decode($type = null) {
		...
		if (function_exists('amf_decode')) {
			if (!class_exists('AmfCallback')) {
				App::import('Vendor', 'Amf.callback');
			}
