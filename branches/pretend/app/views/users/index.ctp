<?php /* SVN FILE: $Id: index.ctp 12 2008-03-11 01:42:39Z gwoo.cakephp $ */?>
...
<tr>
	...
	<th><?php echo $paginator->sort('psword');?></th>
	<th><?php echo $paginator->sort('temppassword');?></th>
	<th><?php echo $paginator->sort('tos');?></th>
	<th><?php echo $paginator->sort('email_authenticated');?></th>
	<th><?php echo $paginator->sort('email_token');?></th>
	<th><?php echo $paginator->sort('email_token_expires');?></th>
