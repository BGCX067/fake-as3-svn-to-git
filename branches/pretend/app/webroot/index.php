<?php
/* SVN FILE: $Id: index.php 15 2008-03-11 03:50:08Z xpointsh $ */
/**
 ...
 * @lastmodified	$Date: 2008-03-11 09:50:08 +0600 (Tue, 11 Mar 2008) $
 ...
 */
	if (!defined('CAKE_CORE_INCLUDE_PATH')) {
		...
		//You should also use the DS define to separate your directories
		define('CAKE_CORE_INCLUDE_PATH', '/opt/local/apache2/htdocs');
	}
///////////////////////////////
...
///////////////////////////////
	...
	if (isset($_GET['url']) && $_GET['url'] === 'favicon.ico') {
		...
		App::import('Vendor', 'Amf.amf_dispatcher');
