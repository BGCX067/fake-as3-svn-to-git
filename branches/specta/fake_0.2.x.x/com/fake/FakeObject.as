/* SVN FILE: $Id: FakeObject.as 219 2008-10-06 13:27:18Z xpointsh $ */
/**
 * Description
 *
 * Fake
 ...
 * @lastmodified	$Date: 2008-10-06 20:27:18 +0700 (Mon, 06 Oct 2008) $
...
package com.fake
{
	...
	public dynamic class FakeObject extends Proxy implements IEventDispatcher
	{
		...
		*/
		 ...
		 * DescribeUtil.localName and getDefinitionByName
		 */
		private function getClassInfo():void
		{
			className = DescribeUtil.localName(this);
			ClassRef = DescribeUtil.classReference(this);
		}
